...
using RoBERTa-large across multiple healthcare sites.
"""
...
def train_eval(
    ...
    Args:
        ...
        model_path: Path to pre-trained RoBERTa model
    ...
    training_args = TrainingArguments(
        output_dir=f"/results/roberta_iecv_{test_site}_holdout",
        ...
        logging_dir=f"/logs/roberta_logs_{test_site}",
        seed=seed_value,
...
def main():
    ...
    # Path to pre-trained RoBERTa model
    model_path = "/llm_model_files/roberta-large/"
    ...
    with open("/results/roberta_iecv_results.json", "w") as f:
        json.dump(results_summary, f, indent=2)
    
    print("\nResults saved to /results/roberta_iecv_results.json")
